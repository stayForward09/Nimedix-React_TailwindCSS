  ...
  return (
    <div id="download-section" className="bg-white sm:py-24 py-12">
      <div className="container mx-auto">
        <div className="bg-primary rounded-3xl md:p-16 sm:p-8 p-4 border-box grid md:gap-32 sm:gap-16 gap-8 lg:grid-cols-2 grid-cols-1 items-center">
          <div className="block">
            ...
            <p className="text-grey-light sm:my-8 my-4 md:text-2xl sm:text-base text-sm">
